...
const { PAYMENT_CAPTURED, PAYMENT_INIT } = require("./types");
...
//Razorpay Poup Form
export const loadRazorpayToggle = (price, name, phone) => async (dispatch) => {
  ...
  var options = {
    ...
    prefill: {
      name: name,
      email: `${name && name.split(" ")[0]}@yammyfoods.com`,
      contact: phone,
    },
    notes: {
...
//init Razorpay
export const initRazorpay = () => (dispatch) => {
  dispatch({
    type: PAYMENT_INIT,
    payload: "Fail",
  });
